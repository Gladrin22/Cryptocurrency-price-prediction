...
st.write('(Bitcon , Ethereum , Binance, Dogecoin , Litecoin)')

stocks = ('BTC-USD','ETH-USD','BNB-USD','DOGE-USD','LTC-USD')  #Stocks we are using to predict
...
data_load_state = st.text('Loading & Processing Data...')         #Text to be displayed before and after downloading of the data 
data = load_data(selected_stocks)
data_load_state.text('Awesome ! Done :-)')
